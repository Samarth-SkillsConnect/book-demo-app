...
//   <div className="w-[100%] lg:w-[70%] bg-white rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden border border-gray-100">
//     {/* Left Panel: Company Info */}
//     <div className="w-full md:w-[35%] flex flex-col items-center md:items-start px-6 py-8 md:py-10 border-b md:border-b-0 md:border-r border-gray-200 min-h-[400px]">
//       <div className="w-full flex flex-col items-center md:items-start">
//         {/* Company Logo / Info */}
//         <img className="w-40" src="https://skillsconnect.blob.core.windows.net/skillsconnect/assets/frontend/images/logo/skillsconnect-logo-n.svg"></img>
//         {/* <CompanyInfo /> */}

//         {/* Book Demo Title & Info */}
//         <div className="w-full mt-6">

//           <h1 className="text-3xl font-bold text-[#0a2342] mb-4">Book Demo</h1>
...
//     <div className="w-full md:w-[65%] flex flex-col px-4 sm:px-8 py-8 md:py-10 relative">

//       <h2 className="text-xl md:text-2xl font-bold mb-2 text-[#0a2342] text-center">Select a Date &amp; Time</h2>
...
//         <h2 className="text-center text-lg pt-2 font-semibold text-[#0a2342]">
