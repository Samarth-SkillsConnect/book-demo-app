...
//   // const [showCustomSlotPopup, setShowCustomSlotPopup] = useState(false);
//   const [showAddCustomSlotPopup, setShowAddCustomSlotPopup] = useState(false);
...
//       weekDays.map((wd) => {
//         // Try to find config for this day
//         const config = slots.find((c) => c.day === wd.key);
//         if (config) {
//           return {
//             day: wd.key,
//             name: wd.name,
...
//               onClick={() => setShowCustomSlotPopup((v) => !v)}
//             >
//               {showCustomSlot ? "Hide Custom Slot" : "Add Custom Slot"}
//             </button> */}
//             <button
//               className="bg-green-700 text-white px-6 py-2 rounded-lg shadow hover:bg-green-800 font-semibold transition"
//               onClick={() => setShowAddCustomSlotPopup(true)}
//             >
//               Add Custom Slot
//             </button>
//           </div>
...
//         <div
//           className="overflow-x-auto bg-white rounded-xl shadow-xl border-2 border-[#bfe7ef] overflow-hidden"
//           style={{
//             minWidth: "900px",
...
//           <div className="bg-white rounded-2xl shadow-xl p-8 max-w-[42rem] w-full border border-[#bfe7ef] relative">
//             <button
//               className="absolute top-3 right-3 text-gray-400 hover:text-black text-2xl"
//               onClick={() => setShowAddCustomSlotPopup(false)}
//               aria-label="Close"
//             >
//               &times;
//             </button>
